  ...
  return (function e(t, n, r) {
  ...
  })(
    {
          ...
          function GlyphNames(post) {
            ...
            switch (post.version) {
              ...
              case 2:
                ...
                for (i = 0; i < post.numberOfGlyphs; i++) {
                  if (post.glyphNameIndex[i] < exports.standardNames.length) {
                    this.names[i] =
                      exports.standardNames[post.glyphNameIndex[i]];
                  } else {
                    this.names[i] =
                      post.names[
                        post.glyphNameIndex[i] - exports.standardNames.length
                      ];
                  }
                }
                break;
              case 2.5:
                ...
                for (i = 0; i < post.numberOfGlyphs; i++) {
                  this.names[i] =
                    exports.standardNames[i + post.glyphNameIndex[i]];
                }
                break;
              case 3:
                this.names = [];
      ...
      4: [
        function(require, module, exports) {
          ...
          Font.prototype.getKerningValue = function(leftGlyph, rightGlyph) {
            ...
            return gposKerning
              ? gposKerning(leftGlyph, rightGlyph)
          ...
          Font.prototype.validate = function() {
            ...
            function assertStringAttribute(attrName) {
              assert(
                font[attrName] && font[attrName].trim().length > 0,
                'No ' + attrName + ' specified.'
              );
            }
        ...
        { './encoding': 3, './path': 8, './tables/sfnt': 23 }
      ],
      5: [
        function(require, module, exports) {
          // The Glyph object
        ...
        function(require, module, exports) {
          ...
          function loadFromUrl(url, callback) {
            ...
            request.onload = function() {
              if (request.status !== 200) {
                return callback(
                  'Font could not be loaded: ' + request.statusText
                );
              }
          ...
          function load(url, callback) {
            ...
            loadFn(url, function(err, arrayBuffer) {
              ...
              if (!font.supported) {
                return callback(
                  'Font is not supported (is this a Postscript font?)'
                );
              }
      ...
      7: [
        function(require, module, exports) {
          ...
          Parser.prototype.parseVersion = function() {
            var major = exports.getUShort(
              this.data,
              this.offset + this.relativeOffset
            );
            // How to interpret the minor version is very vague in the spec. 0x5000 is 5, 0x1000 is 1
            // This returns the correct number if minor = 0xN000 where N is 0-9
            var minor = exports.getUShort(
              this.data,
          ...
          Path.prototype.toPathData = function(decimalPlaces) {
            ...
            for (var i = 0; i < this.commands.length; i += 1) {
              ...
              if (cmd.type === 'M') {
                ...
                d +=
                  'C' +
                  packValues(cmd.x1, cmd.y1, cmd.x2, cmd.y2, cmd.x, cmd.y);
              } else if (cmd.type === 'Q') {
          ...
          Table.prototype.sizeOf = function() {
            ...
            for (var i = 0; i < this.fields.length; i += 1) {
              ...
              if (typeof value.sizeOf === 'function') {
                ...
                check.assert(
                  typeof sizeOfFunction === 'function',
                  'Could not find sizeOf function for field' + field.name
                );
        ...
        function(require, module, exports) {
                ...
                switch (v) {
                  ...
                  case 12: // flex operators
                    ...
                    switch (v) {
                      ...
                      default:
                        console.log(
                          'Glyph ' + index + ': unknown operator ' + 1200 + v
                        );
                        stack.length = 0;
                    }
                    break;
          ...
          function parseCFFTable(data, start, font) {
            ...
            if (topDict.encoding === 0) {
              // Standard encoding
              font.cffEncoding = new encoding.CffEncoding(
          ...
          function makePrivateDictIndex(privateDict) {
            ...
            t.privateDicts = [
              { name: 'privateDict_0', type: 'TABLE', value: privateDict }
            ];
            return t;
          }
      ...
      11: [
        function(require, module, exports) {
          ...
          function parseCmapTable(data, start) {
            ...
            startCountParser = new parse.Parser(
              data,
              start + offset + 16 + segCount * 2
            );
            idDeltaParser = new parse.Parser(
              data,
              start + offset + 16 + segCount * 4
            );
            idRangeOffsetParser = new parse.Parser(
              data,
          ...
          function makeCmapTable(glyphs) {
            ...
            t.searchRange =
              Math.pow(2, Math.floor(Math.log(segCount) / Math.log(2))) * 2;
      ...
      12: [
        function(require, module, exports) {
          ...
          function parseGlyph(data, start, index, font) {
            ...
            if (glyph.numberOfContours > 0) {
              ...
              numberOfCoordinates =
                endPointIndices[endPointIndices.length - 1] + 1;
              flags = [];
        ...
        { '../check': 1, '../glyph': 5, '../parse': 7, '../path': 8 }
      ],
      13: [
        function(require, module, exports) {
          ...
          function parseLookupTable(data, start) {
            ...
            if (lookupType === 2) {
              ...
              for (i = 0; i < subTableCount; i++) {
                subtables.push(
                  parsePairPosSubTable(data, start + subTableOffsets[i])
                );
              }
          ...
          function parseGposTable(data, start, font) {
            ...
            for (i = 0; i < lookupCount; i++) {
              table = parseLookupTable(
                data,
                lookupListAbsoluteOffset + lookupTableOffsets[i]
              );
      ...
      20: [
        function(require, module, exports) {
          ...
          function addMacintoshNameRecord(t, recordID, s, offset) {
            ...
            t.records.push(
              makeNameRecord(1, 0, 0, recordID, stringBytes.length, offset)
            );
          ...
          function addWindowsNameRecord(t, recordID, s, offset) {
            ...
            t.records.push(
              makeNameRecord(3, 1, 0x0409, recordID, utf16Bytes.length, offset)
            );
      ...
      23: [
        function(require, module, exports) {
          ...
          function makeSfntTable(tables) {
            ...
            var offset =
              sfnt.sizeOf() + makeTableRecord().sizeOf() * sfnt.numTables;
            while (offset % 4 !== 0) {
              offset += 1;
          ...
          function fontToSfntTable(font) {
            ...
            var hheaTable = hhea.make({
              ...
              xMaxExtent:
                globals.maxLeftSideBearing + (globals.xMax - globals.xMin),
            ...
            var postScriptName =
              font.familyName.replace(/\s/g, '') + '-' + font.styleName;
      ...
      24: [
        function(require, module, exports) {
          ...
          encode.INDEX = function(l) {
            ...
            encodedOffsets = [];
            offSize =
              (1 + Math.floor(Math.log(dataSize) / Math.log(2)) / 8) | 0;
            offsetEncoder = [
              undefined,
              encode.BYTE,
              encode.USHORT,
          ...
          encode.TABLE = function(table) {
            ...
            for (i = 0; i < length; i += 1) {
              ...
              check.argument(
                encodingFunction !== undefined,
                'No encoding function for field type ' + field.type
              );
